...
import net.opanasyuk.springbatch.common.StudentProcessor;
...
public class CsvDbJobLauncher {
    ...
    @Autowired
    private CsvDbJobLauncher(@Qualifier("csvFileToDatabaseJob") Job job, JobLauncher jobLauncher) {
        this.job = job;
